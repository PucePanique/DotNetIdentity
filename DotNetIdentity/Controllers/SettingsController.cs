...
namespace DotNetIdentity.Controllers
{
    ...
    public class SettingsController : Controller {
        ...
        public async Task<IActionResult> restoreStyle () {
            ...
            _settings.Brand.ApplicationName = "CesiZen";
            _settings.Brand.ColorDanger = "#f5023c";
            _settings.Brand.ColorInfo = "#2196f3";
            _settings.Brand.ColorLightBackground = "#f9f9df";
            _settings.Brand.ColorPrimary = "#557209";
            _settings.Brand.ColorSuccess = "#00c853";
            _settings.Brand.ColorWarning = "#ff9800";
            _settings.Brand.ColorSecondary = "#95A617";
            _settings.Brand.ColorHeadlines = "#557209";
            _settings.Brand.ColorLink = "#f5023c";
            _settings.Brand.ColorTextMuted = "#95A617";
            //_settings.Brand.ApplicationLogo = "wwwroot\\assets\\images\\logo\\favicon.ico";
