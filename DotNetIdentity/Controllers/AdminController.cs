    ...
    public class AdminController : Controller
    {
        ...
        public async Task<ActionResult> NewUser(NewUserModel viewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                user.Department = viewModel.userType.ToString();
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            {
                viewModel.userType = Enum.Parse<UserType>(departmentClaim.Value);
            }
                ...
                if (user != null)
                {
                    ...
                    else
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            var claimsToAdd = new Claim("Department", Enum.GetName(viewModel.userType)!);
                            if (departmentClaim != null)
                            {
